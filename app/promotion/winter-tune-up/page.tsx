    ...
    return (
        <main className="min-h-screen bg-gray-50">
            ...
            <section className="relative w-full h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden pt-32 pb-20">
                ...
                <Image
                    src="/images/promotion/winter-tune-up-hero.png" // Will fallback or need to be replaced
            ...
            <section className="py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            { title: "Physiotherapy", href: "/services/physiotherapy-burnaby-vancouver", desc: "Movement assessment, pain management, and functional rehabilitation." },
                            { title: "Massage Therapy (RMT)", href: "/services/massage-therapy-burnaby-vancouver", desc: "Soft-tissue care and tension reduction." },
                            { title: "Acupuncture & TCM", href: "/services/acupuncture-burnaby-vancouver", desc: "Supportive care for pain, circulation, and recovery." },
                            { title: "Chiropractic Care", href: "/services/chiropractic-care-burnaby-vancouver", desc: "Joint mobility and spinal function support." },
                            { title: "Kinesiology", href: "/services/kinesiology-burnaby-vancouver", desc: "Active rehabilitation and movement retraining." },
                            { title: "Clinical Counseling", href: "/services/clinical-counseling-burnaby-vancouver", desc: "Mental wellness support for stress, pain management, and resilience." },
                        ].map((service, i) => (
                            <Link
                                href={service.href}
                                key={i}
